...
const CHARTS: Chart[] = [
  {
    name: "Area Chart",
    description: "Display data trends using filled areas sections.",
    Component: AreaPreview,
    url: "/docs/area-chart",
  },
  {
    name: "Line Chart",
    description: "Display data trends using lines.",
  ...
  {
    name: "Composed Chart",
    description: "Display multiple data trends using lines, bars, and areas.",
    Component: ComposedPreview,
    url: "/docs/composed-chart",
  },
  {
    name: "Radar Chart",
    description: "Display data trends using a radar chart.",
    Component: RadarPreview,
    url: "/docs/radar-chart",
  },
  {
    name: "Pie Chart",
    description: "Display data trends using a pie chart.",
    Component: PiePreview,
    url: "/docs/pie-chart",
  },
  {
    name: "Radial Chart",
    description: "Display data trends using a radial chart.",
    Component: RadialPreview,
    url: "/docs/radial-chart",
  },
  {
    name: "Sankey Chart",
    description: "Display data trends using a sankey chart.",
