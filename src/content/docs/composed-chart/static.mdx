...
<ApiReferenceWrapper>
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      Array of data keys that should have a neon effect applied to their bars. Creates a multi-layered glow with a bright white core. Neon effect takes priority over glow effect.
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      Array of data keys that should have a neon effect applied to their lines. Creates a multi-layered glow with a bright white core. Neon effect takes priority over glow effect.
