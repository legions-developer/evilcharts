...
<ApiReferenceWrapper>
  ...
  <ApiReference>
    <ApiHeader
      propName="defaultSelectedSector"
    />
    <ApiContent>
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      Additional props forwarded to the underlying Recharts PieChart component.
...
<ApiReferenceWrapper>
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      Escape hatch for raw props forwarded to the underlying Recharts Pie component.
...
<ApiReferenceWrapper>
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      Escape hatch for raw props forwarded to the underlying Recharts LabelList component.
