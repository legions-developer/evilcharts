...
<ApiReferenceWrapper>
  ...
  <ApiReference>
    <ApiHeader
      propName="neonSectors"
    />
    <ApiContent>
      Array of sector names (values from your `nameKey` field) that should have a neon effect applied. Creates a multi-layered glow with a bright white core. Neon effect takes priority over glow effect.
