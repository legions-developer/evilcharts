...
<ApiReferenceWrapper>
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      All other props are forwarded to the underlying Recharts PolarGrid component.
...
<ApiReferenceWrapper>
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      All other props are forwarded to the underlying Recharts PolarAngleAxis component.

      type: `ComponentProps<typeof PolarAngleAxis>`

      Read the <Link href="https://recharts.github.io/en-US/api/PolarAngleAxis/" _blank>Recharts PolarAngleAxis documentation</Link> for available props.
    </ApiContent>
  </ApiReference>
</ApiReferenceWrapper>
...
<ApiReferenceWrapper>
  <ApiReference>
    ...
    />
    <ApiContent>
      All props are forwarded to the underlying Recharts PolarRadiusAxis component.

      type: `ComponentProps<typeof PolarRadiusAxis>`

      Read the <Link href="https://recharts.github.io/en-US/api/PolarRadiusAxis/" _blank>Recharts PolarRadiusAxis documentation</Link> for available props.
    </ApiContent>
  </ApiReference>
</ApiReferenceWrapper>
