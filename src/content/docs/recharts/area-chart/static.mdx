...
links:
  github: https://github.com/legions-developer/evilcharts/blob/main/src/registry/charts/recharts-area-chart.tsx
      ...
      <Step>
        ...
        <StepContent>
          <ComponentSource
            ...
            title="components/evilcharts/charts/recharts-area-chart.tsx"
          />
        </StepContent>
      </Step>
       <Step>
        ...
        <StepContent>
          <ComponentSource
            name="recharts-chart"
            title="components/evilcharts/ui/recharts-chart.tsx"
          />
        </StepContent>
      </Step>
       <Step>
        ...
        <StepContent>
          <ComponentSource
            ...
            title="components/evilcharts/ui/recharts-tooltip.tsx"
          />
        </StepContent>
        <StepDescription>
        ...
        <StepContent>
          <ComponentSource
            ...
            title="components/evilcharts/ui/recharts-legend.tsx"
          />
        </StepContent>
        <StepDescription>
        ...
        <StepContent>
          <ComponentSource
            name="recharts-dot"
            title="components/evilcharts/ui/recharts-dot.tsx"
          />
        </StepContent>
      </Step>
    </Steps>
