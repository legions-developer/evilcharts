...
<ApiTable>
  ...
  <ApiRow name="sankeyProps" type='Omit<SankeyProps, "data">'>
    Additional props to pass to the underlying Recharts Sankey component. Read the <Link href="https://recharts.github.io/en-US/api/Sankey/" _blank>Recharts Sankey documentation</Link> for available props.
  </ApiRow>
</ApiTable>
