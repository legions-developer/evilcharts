---
title: Sankey Chart
description: Sankey charts for flow data with nodes and links, plus gradient colors and glow effects
image: /og/sankey-chart.png
links:
  github: https://github.com/legions-developer/evilcharts/blob/main/src/registry/charts/recharts-sankey-chart.tsx
...
<CodeTabs>
  ...
  <TabsPanel value="cli">
    <CliBlock commands={["@evilcharts/recharts-sankey-chart"]} />
  </TabsPanel>
    ...
    <Steps>
      ...
      <Step>
        <StepTitle>Copy the code below into your project.</StepTitle>
         <StepDescription>
          Create an `evilcharts` folder with a `charts` subfolder inside your `components` directory, then copy the base recharts-sankey-chart code into a new file there.
        </StepDescription>
        <StepContent>
          <ComponentSource
            name="recharts-sankey-chart"
            title="components/evilcharts/charts/recharts-sankey-chart.tsx"
          />
        </StepContent>
      </Step>
       <Step>
...
<Alert> 
  <AlertContent>
    Pass an array of node names to the `glow` prop on `<Node />` to add a subtle glow to those nodes.
  </AlertContent>
</Alert>
...
<ApiTable>
  ...
  <ApiRow name="sankeyProps" type='Omit<SankeyProps, "data">'>
    Extra props for the underlying Recharts Sankey component. See the <Link href="https://recharts.github.io/en-US/api/Sankey/" _blank>Recharts Sankey documentation</Link> for available props.
  </ApiRow>
</ApiTable>
...
<ApiTable>
  ...
  <ApiRow name="glow" type="string[]" default="[]">
    Node names to apply a glow effect to. Renders a smooth outer glow around them.
  </ApiRow>
...
<ApiTable>
  ...
  <ApiRow name="glow" type="number[]" default="[]">
    Link indices to apply a glow effect to. Renders a smooth outer glow around them.
  </ApiRow>
</ApiTable>
