...
<CodeTabs>
  ...
  <TabsPanel value="cli">
    <CliBlock commands={["@evilcharts/recharts-line-chart"]} />
  </TabsPanel>
...
<ApiTable>
  ...
  <ApiRow name="brushHeight" type="number">
    Brush preview height, in pixels.
  </ApiRow>
  ...
  <ApiRow name="chartProps" type="ComponentProps<typeof LineChart>">
    Extra props forwarded to the underlying Recharts LineChart. See the <Link href="https://recharts.github.io/en-US/api/LineChart/" _blank>Recharts LineChart documentation</Link>.
  </ApiRow>
</ApiTable>
...
<ApiTable>
  ...
  <ApiRow name="…axisProps">
    Every other Recharts XAxis / YAxis prop is forwarded as-is. See the <Link href="https://recharts.github.io/en-US/api/XAxis/" _blank>Recharts XAxis</Link> and <Link href="https://recharts.github.io/en-US/api/YAxis/" _blank>Recharts YAxis</Link> docs.
  </ApiRow>
</ApiTable>
