...
links:
  github: https://github.com/legions-developer/evilcharts/blob/main/src/registry/charts/recharts-composed-chart.tsx
    ...
    <Steps>
      ...
      <Step>
        <StepTitle>Copy and paste the following code snippets into your project.</StepTitle>
         <StepDescription>
          Create an `evilcharts` folder with a `charts` subfolder inside `components`, then paste the base recharts-composed-chart code into a new file there.
        </StepDescription>
        <StepContent>
          <ComponentSource
            name="recharts-composed-chart"
            title="components/evilcharts/charts/recharts-composed-chart.tsx"
          />
        </StepContent>
      </Step>
       <Step>
