...
<ApiTable>
  ...
  <ApiRow name="chartProps" type="ComponentProps<typeof RadialBarChart>">
    Additional props forwarded to the underlying Recharts RadialBarChart component. Read the <Link href="https://recharts.github.io/en-US/api/RadialBarChart/" _blank>Recharts RadialBarChart documentation</Link> for available props.
  </ApiRow>
</ApiTable>
...
<ApiTable>
  ...
  <ApiRow name="radialBarProps" type='Omit<ComponentProps<typeof RadialBar>, "dataKey">'>
    Additional props forwarded to the underlying Recharts RadialBar component. Read the <Link href="https://recharts.github.io/en-US/api/RadialBar/" _blank>Recharts RadialBar documentation</Link> for available props.
  </ApiRow>
</ApiTable>
