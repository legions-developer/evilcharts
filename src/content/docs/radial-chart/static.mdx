...
<ApiReferenceWrapper>
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      Array of bar names (values from your `nameKey` field) that should have a neon effect applied. Creates a multi-layered glow with a bright white core. Neon effect takes priority over glow effect.
