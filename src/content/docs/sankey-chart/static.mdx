...
<ApiReferenceWrapper>
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      Array of node names that should have a neon effect applied. Creates a multi-layered glow with a bright white core. Neon effect takes priority over glow effect.
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      Array of link indices that should have a neon effect applied. Creates a multi-layered glow with a bright white core. Neon effect takes priority over glow effect.
