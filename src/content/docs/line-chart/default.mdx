...
<ApiReferenceWrapper>
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      Array of data keys that should have a glowing effect applied. Creates a smooth outer neon glow around the specified lines.
  ...
  <ApiReference>
    ...
    />
    <ApiContent>
      Array of data keys that should have a neon effect applied. Creates a multi-layered glow with a bright white core for the specified lines. Neon effect takes priority over glow effect.
